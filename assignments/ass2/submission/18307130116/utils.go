...
var (
	// YOUR CODE BELOW
	EvaluatorID   = "18307130116" // your student id, e.g. 18307130177
	SubmissionDir = "/home/musicode/Desktop/assignment2/IDBS-Spring20-Fudan-master/assignments/ass1/submission/" // the relative path the the submission directory of assignment 1, it should be "../../../ass1/submission/"
...
// `comparison_result` and inserts the score of each submitter on each query into table `score`
